...
###modified by Josh Stowe, DU Bootcamp Jul/7/2022
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (f"{county_name}: {county_percent:.1f}% ({countyVote:,})\n")
        ...
        if (countyVote>county_turnout):
            county_turnout = countyVote
